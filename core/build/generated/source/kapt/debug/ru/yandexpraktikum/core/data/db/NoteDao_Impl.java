...
public final class NoteDao_Impl implements NoteDao {
  ...
  @Override
  public Object update(final NoteEntity note, final Continuation<? super Integer> $completion) {
      ...
      public List<NoteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new NoteEntity(_tmpId,_tmpTitle,_tmpContent);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public NoteEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new NoteEntity(_tmpId,_tmpTitle,_tmpContent);
          } else {
            _result = null;
          }
          return _result;
